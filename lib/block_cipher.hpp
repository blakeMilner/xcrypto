...
static unsigned char inv_rijndael_sbox[16][16] =
{
...
CR_str rjindael_mix_column(string r);
CR_str substitute_bytes(string input);
CR_str mix_columns(string input);
CR_str shift_rows(string input);
CR_str rjindael_apply_round_key(CR_str plaintext, const vector<string>& key, int round);

CR_str rjindael_unmix_column(string r);
CR_str unsubstitute_bytes(string input);
CR_str unmix_columns(string input);
CR_str unshift_rows(string input);
CR_str unadd_round_key(const string& plaintext, const vector<string>& key, const int& round);
