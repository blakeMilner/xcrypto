...
//static const uint8_t rijndael_sbox[16][16] =
//{
...
//};
//
//static const uint8_t inv_rijndael_sbox[16][16] =
//{
...
public:
	...
	static constexpr uint8_t inv_rijndael_sbox[16][16] =
	{
	   {0x52, 0x09, 0x6A, 0xD5, 0x30, 0x36, 0xA5, 0x38, 0xBF, 0x40, 0xA3, 0x9E, 0x81, 0xF3, 0xD7, 0xFB},
	   {0x7C, 0xE3, 0x39, 0x82, 0x9B, 0x2F, 0xFF, 0x87, 0x34, 0x8E, 0x43, 0x44, 0xC4, 0xDE, 0xE9, 0xCB},
	   {0x54, 0x7B, 0x94, 0x32, 0xA6, 0xC2, 0x23, 0x3D, 0xEE, 0x4C, 0x95, 0x0B, 0x42, 0xFA, 0xC3, 0x4E},
...
private:
	static uint8_t rjindael_sbox_lookup(uint8_t input);
	static uint8_t inv_rjindael_sbox_lookup(uint8_t input);
	...
	static CR_str rjindael_apply_round_key(CR_str plaintext, const vector<string>& key, int round);
